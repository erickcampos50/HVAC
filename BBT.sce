...
entradas =[23.0  	0.4	7	23	1	200	7	23	13	6.5	10	14	2	3	    17.0	7350]
...
w = [35	90	1	2.41	86	11	strtod(alpha_tab(12,2))
125	90	1	2.41	82	14	strtod(alpha_tab(12,2))
-145	90	1	2.41	0	0	strtod(alpha_tab(12,2))
-55	90	1	2.41	31	3	strtod(alpha_tab(12,2))
]//sala de estudos
//estacionamento
//orient. Interna
//hall externo
