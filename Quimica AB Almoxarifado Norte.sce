...
entradas = [23.0  	0.4	7	18	1	2	7	18	13	6.5	3	14	2	3	17	476.4]
...
w = [125.00	90.00	1.00	2.41	13.05	2.40	strtod(alpha_tab(12,2))
0.00	0.00	1.00	2.41	27.56	0.00	strtod(alpha_tab(12,2))
]
