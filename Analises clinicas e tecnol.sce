...
entradas = [23.0  	0.4	7	18	1	30	7	18	13	6.5	5.4	14	2	3	17	1654.8]
...
w = [125.00	90.00	1.00	2.41	28.68	4.32	strtod(alpha_tab(12,2))
0.00	0.00	1.00	2.41	58.3	0.00	strtod(alpha_tab(12,2))]
