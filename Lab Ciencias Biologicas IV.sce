...
entradas = [23.0  	0.4	7	18	1	35	7	18	13	6.5	1.8	14	2	3	17	1789.8]
...
w = [-55.00	90.00	1.00	2.41	13.56	1.44	strtod(alpha_tab(12,2))
0.00	0.00	1.00	2.41	60	0.00	strtod(alpha_tab(12,2))]
