...
entradas = [23.0  	0.4	7	18	1	10	7	18	13	6.5	4.2	14	2	3	17	551.6]
...
w = [-55.00	90.00	1.00	2.41	15.84	3.36	strtod(alpha_tab(12,2))
0.00	0.00	1.00	2.41	23.04	0.00	strtod(alpha_tab(12,2))]
