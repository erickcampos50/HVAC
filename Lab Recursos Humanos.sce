...
entradas = [23.0  	0.4	7	18	1	50	7	18	13	6.5	10	14	2	3	    17.0	3350]
...
w = [35	90	1	2.41	0	0	strtod(alpha_tab(12,2))
125	90	1	2.41	82	14	strtod(alpha_tab(12,2))
-145	90	1	2.41	23	8	strtod(alpha_tab(12,2))
-55	90	1	2.41	50	18	strtod(alpha_tab(12,2))]
//]Secretaria da FPF
//hall externo
//orient. Interna
//estacionamento
