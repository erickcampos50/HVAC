...
entradas = [23.0  	0.4	7	18	1	60	7	18	13	6.5	4.9	14	2	3	17	4436]
...
w = [35.00	90.00	1.00	2.41	46.18	3.92	strtod(alpha_tab(12,2))
125.00	90.00	1.00	2.41	73.00	8.00	strtod(alpha_tab(12,2))
-145.00	90.00	1.00	2.41	24.60	0.00	strtod(alpha_tab(12,2))
0.00	0.00	1.00	2.41	348.90	0.00	strtod(alpha_tab(12,2))
]
