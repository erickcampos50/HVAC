...
entradas = [23.0  	0.4	7	20	1	100	7	20	13	6.5	22.2	14	2	3	17	6645.2]
...
w = [35.00	90.00	1.00	2.41	27.84	8.16	strtod(alpha_tab(12,2))
125.00	90.00	1.00	2.41	17.80	3.20	strtod(alpha_tab(12,2))
-55.00	90.00	1.00	2.41	25.00	8.00	strtod(alpha_tab(12,2))]
//]Secretaria da FPF
//hall externo
//orient. Interna
//estacionamento
