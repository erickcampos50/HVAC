...
entradas = [23.0  	0.4	7	18	1	30	7	18	13	6.5	2.1	14	2	3	17	1373.2]
...
w = [125.00	90.00	1.00	2.41	27.72	1.68	strtod(alpha_tab(12,2))
0.00	0.00	1.00	2.41	49	0.00	strtod(alpha_tab(12,2))
]
