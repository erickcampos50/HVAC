...
entradas = [23.0  	0.4	7	18	1	30	7	18	13	6.5	4.4	14	2	3	17	810
]
...
w = [35.00	90.00	1.00	2.41	19.28	3.52	strtod(alpha_tab(12,2))
-145.00	90.00	1.00	2.41	19.28	3.52	strtod(alpha_tab(12,2))
-55.00	90.00	1.00	2.41	24.90	0.00	strtod(alpha_tab(12,2))
0.00	0.00	1.00	2.41	63.08	0.00	strtod(alpha_tab(12,2))
]
