...
entradas = [23.0  	0.4	7	18	1	52	7	18	13	6.5	5.6	14	2	3	17	2248.8]
...
w = [-145.00	90.00	1.00	2.41	12.92	4.48	strtod(alpha_tab(12,2))
125.00	90.00	1.00	2.41	28.80	0.00	strtod(alpha_tab(12,2))
]
