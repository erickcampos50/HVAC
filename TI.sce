...
entradas = [18  	0.4	7	18	1	5	7	18	13	6.5	6.6	14	2	3	17	1633]
...
w = [125.00	90.00	1.00	2.41	19.80	0.00	strtod(alpha_tab(12,2))
-145.00	90.00	1.00	2.41	17.95	3.20	strtod(alpha_tab(12,2))]
