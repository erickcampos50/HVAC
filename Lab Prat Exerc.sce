...
entradas = [23.0  	0.4	7	18	1	30	7	18	13	6.5	7	14	2	3	17	810]
...
w = [-145.00	90.00	1.00	2.41	28.90	5.60	strtod(alpha_tab(12,2))
0.00	0.00	1.00	2.41	54.00	0.00	strtod(alpha_tab(12,2))
]
