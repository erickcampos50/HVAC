...
entradas =[23.0  	0.4	7	18	1	30	7	18	13	6.5	6	14	2	3	17	2218]
...
w = [-145.00	90.00	1.00	2.41	32.70	4.80	strtod(alpha_tab(12,2))
0.00	0.00	1.00	2.41	125.00	0.00	strtod(alpha_tab(12,2))]
