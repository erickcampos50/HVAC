...
entradas = [23.0  	0.4	7	18	1	30	7	18	13	6.5	6	14	2	3	17	1654.8]
...
w = [35.00	90.00	1.00	2.41	20.40	4.80	strtod(alpha_tab(12,2))
-145.00	90.00	1.00	2.41	22.14	3.36	strtod(alpha_tab(12,2))
-55.00	90.00	1.00	2.41	25.50	0.00	strtod(alpha_tab(12,2))
0.00	0.00	1.00	2.41	71.40	0.00	strtod(alpha_tab(12,2))]
